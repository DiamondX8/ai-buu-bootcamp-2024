...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ภาวินท์ คือ สุดหล่อ SE",
        "ภาวินท์ กำลังศึกษาที่มหาวิทยาลัยบูรพา สาขาวิศวกรรมซอฟต์แวร์",
        ...
        "มหาวิทยาลัยบูรพา สาขาวิชาSE ปีการศึกษา 2565 มีนักศึกษาจำนวน 97 คน มีอาจารย์ที่ปรึกษา 5 คน",
        "ClickNext team AI มี พี่เจ๋ง ทำหน้าที่เป็น Dev พี่ดาว ทำหน้าที่เป็น BA พี่ปาร์ม ทำหน้าที่เป็น Backend และพี่ชวน ทำหน้าที่เป็น Dataops ทั้งหมด 5 คน"
    ]
